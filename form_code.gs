...
const APP_FOLDER_NAME = "Customer detail CC (File responses)";
...
function onFormSubmit(e) {
  try {
   ...
   var parentFolder=DriveApp.getFolderById("1Voj0Q5kr-KOE8gza6l--maJ4kJ8z7I4eFP2ErmQFso0bbzcq7UXZTOjwk2E2im7JimfY_OrR");
    ...
    //var lastResponse = itemResponses[itemResponses.length-1];
    var name = itemResponses[0].getResponse() ;
    var destFolder = getSubFolder_(parentFolder,name.replace('@','_'));
